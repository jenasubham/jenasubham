...
function scanImage(img: HTMLImageElement, size: number): RawParticle[] {
  ...
  // scale image to fill nicely and anchor to the bottom of the canvas
  const scale = 0.98
  ...
  // draw image centered horizontally and anchored flush to the bottom
...
export default function AsciiPortrait() {
  ...
  return (
    <canvas
      ref={canvasRef}
      aria-label="Interactive ASCII portrait of Subham Jena"
      role="img"
      style={{
        width: `${dim}px`,
        height: `${dim}px`,
