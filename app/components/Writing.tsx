...
const POSTS: Post[] = [
  {
    num: '№ 01',
    prefix: 'Bypassing application servers: ',
    italicWord: 'direct-to-cloud',
    suffix: ' SAS uploads for large files',
    title: '',
    meta: 'Article · 2026',
    href: '#',
    forthcoming: true,
  ...
  {
    num: '№ 02',
    prefix: 'Client-side ML: running ',
    italicWord: 'EfficientDet-Lite0',
    suffix: ' directly in the browser',
    title: '',
    meta: 'Article · 2026',
    href: '#',
    forthcoming: true,
